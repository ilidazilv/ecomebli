...
export const Header = () => {
  ...
  return (
    <Navbar expand='md' cssModule={{ navbar: "header wrapper" }}>
      <NavbarBrand
        cssModule={{ "navbar-brand": "navbar-brand-button" }}
        href='/'
      >
      ...
      <Nav
        className='mr-auto w-75 justify-content-center flex-row navbar-custom'
        navbar
      >
        ...
        <div className='w-33 d-flex justify-content-end'>
          <a className='header-link phone' href='tel:0931826235'>
            093 182 62 35
          </a>
          <a className='header-link phone' href='tel:0987554178'>
            098 755 41 78
          </a>
        </div>
      </Nav>
